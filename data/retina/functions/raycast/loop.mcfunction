...
execute at @s if data storage retina:input {TargetEntities: true} if entity @e[type=!#retina:ignore, tag=!retina.ignore, tag=!retina.executing, dx=0, dy=0, dz=0] run function retina:raycast/on_entity_found
